package tw.tcnr02.firebase_chatapp.firebase;
...
import tw.tcnr02.firebase_chatapp.activities.ChatActivity;
...
//        Log.d("FCM", "Message: " + remoteMessage.getNotification().getBody());
        ...
        Log.d("DATA", "Message: " + user.id +" / " + user.name + " / "+user.token); //有資料
